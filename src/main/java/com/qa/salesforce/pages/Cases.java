...
public class Cases {
    ...
    private By clickingSaveBtn_Loc = By.xpath("//records-form-footer[contains(@class,'slds-docked-form-footer')]//ul[@role='presentation']//li[contains(@data-target-selection-name,'SaveEdit')]//button[@name='SaveEdit']");
